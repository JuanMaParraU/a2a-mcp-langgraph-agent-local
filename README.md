...
**📖 Want to understand the architecture and concepts?** Read the [full blog post](blog.md)
...
**Read more:** [Blog post with detailed architecture explanation](blog.md))
...
If you're new to tmux, check out this quick [introduction to tmux](https://github.com/tmux/tmux/wiki/Getting-Started) to get started. It covers the basics of creating, attaching, and managing sessions.
